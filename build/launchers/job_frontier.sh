...
# rsst: true
# EOF
# srun -N 1 -n 8 -c 1 --gpus-per-task=1 --gpu-bind=closest ./abl_neutral ./rsst5.yaml 2>&1 | tee abl_neutral5.out &
# 
# cat <<EOF > rsst6.yaml
# cs: 25
# buoy_theta: true
...
# rsst: true
# EOF
# srun -N 1 -n 8 -c 1 --gpus-per-task=1 --gpu-bind=closest ./abl_neutral ./rsst8.yaml 2>&1 | tee abl_neutral8.out &
# 
# cat <<EOF > rsst9.yaml
# cs: 12
# buoy_theta: true
# rsst: true
# EOF
# srun -N 1 -n 8 -c 1 --gpus-per-task=1 --gpu-bind=closest ./abl_neutral ./rsst9.yaml 2>&1 | tee abl_neutral9.out &
# 
# cat <<EOF > rsst10.yaml
# cs: 10
# buoy_theta: true
