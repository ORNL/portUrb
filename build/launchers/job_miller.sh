...
srun -N $SLURM_NNODES -n $num_tasks -c 32 --gpus-per-task=1 --gpu-bind=closest ./abl_convective_performance

# turbine_convective_ensemble  turbine_neutral_ensemble     turbine_stable_ensemble
