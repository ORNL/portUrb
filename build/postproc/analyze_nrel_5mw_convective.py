...
amrw_z = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_Uhoriz.csv")["z"].to_numpy()
amrw_D = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_Uhoriz.csv")["Uhoriz"].to_numpy()
...
amrw_D = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_T.csv")["T"].to_numpy()
fig = plt.figure(figsize=(5,6))
ax = fig.gca()
...
amrw_D = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_WindDir.csv")["WindDir"].to_numpy()
fig = plt.figure(figsize=(5,6))
ax = fig.gca()
...
amrw_D = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_TI_TKE.csv")["TI_TKE"].to_numpy()
fig = plt.figure(figsize=(5,6))
ax = fig.gca()
...
amrw_uu = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_uu.csv")["uu"].to_numpy()
amrw_uv = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_vv.csv")["vv"].to_numpy()
amrw_uw = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_ww.csv")["ww"].to_numpy()
amrw_vv = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_uv.csv")["uv"].to_numpy()
amrw_vw = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_uw.csv")["uw"].to_numpy()
amrw_ww = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_vw.csv")["vw"].to_numpy()
...
amrw_uT = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_uT.csv")["uT"].to_numpy()
amrw_vT = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_vT.csv")["vT"].to_numpy()
amrw_wT = pd.read_csv("/ccs/home/imn/exawind-benchmarks/amr-wind/atmospheric_boundary_layer/convective_abl_nrel5mw/results/avgprofile_5000s_wT.csv")["wT"].to_numpy()
