...
int main(int argc, char** argv) {
  ...
  yakl::init();
  {
    ...
    int         dyn_cycle   = 1;
    real        out_freq    = 1./6.;
    real        inform_freq = 1./6.;
    std::string out_prefix  = "city_2m_windonly";
    ...
    coupler.set_option<std::string>( "restart_file"          , "city_2m_00000010.nc" );
    ...
    coupler.add_tracer("smoke","",true,false,true);
    coupler.get_data_manager_readwrite().get<real,3>("smoke") = 0;
