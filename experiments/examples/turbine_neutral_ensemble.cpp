...
int main(int argc, char** argv) {
  ...
  yakl::init();
  {
    ...
    coupler_main.set_option<std::string>("ensemble_stdout","ensemble_fixed-yaw-upstream-sine" );
    coupler_main.set_option<std::string>("out_prefix"     ,"turbulent_fixed-yaw-upstream-sine");
