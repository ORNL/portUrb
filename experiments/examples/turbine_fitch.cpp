...
int main(int argc, char** argv) {
  ...
  yakl::init();
  {
    ...
    coupler_prec.set_option<std::string>("ensemble_stdout",std::string("ensemble_z0_")+std::to_string(z0));
    coupler_prec.set_option<std::string>("out_prefix"     ,std::string("windfarm_fitch_z0_")+std::to_string(z0));
