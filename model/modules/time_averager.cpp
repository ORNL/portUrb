...
void Time_Averager::init( core::Coupler &coupler , std::vector<std::string> add_3d_varnames ) {
...
void Time_Averager::reset( core::Coupler &coupler ) {
...
void Time_Averager::accumulate( core::Coupler &coupler , real dt ) {
