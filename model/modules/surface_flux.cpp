...
void SurfaceFlux::init( core::Coupler & coupler ) {
...
void SurfaceFlux::apply( core::Coupler &coupler   ,
                real dt                  ) {
      using yakl::SimpleBounds;
      auto nx          = coupler.get_nx();  // Get local number of grid points in x-direction
      auto ny          = coupler.get_ny();  // Get local number of grid points in y-direction
...
void SurfaceFlux::change_surface_theta( core::Coupler & coupler , real dt , real rate ) {
      using yakl::SimpleBounds;
...
void SurfaceFlux::convert_dynamics_to_coupler( core::Coupler &coupler ,
                                      realConst4d    state   ,
...
void SurfaceFlux::convert_coupler_to_dynamics( core::Coupler const &coupler ,
                                      real4d              &state   ,
