...
void EulerEdgeCentered::enforce_immersed_boundaries( core::Coupler       & coupler ,
                                      real4d        const & state   ,
...
void EulerEdgeCentered::halo_boundary_conditions( core::Coupler & coupler               ,
...
real2d EulerEdgeCentered::compute_average_ghost_column( core::Coupler & coupler ) {
      using yakl::SimpleBounds;
...
void EulerEdgeCentered::copy_precursor_ghost_cells( core::Coupler & coupler_prec , core::Coupler & coupler_main ) {
...
void EulerEdgeCentered::copy_column_to_precursor_ghost_cells( core::Coupler & coupler , real2d const & col ) {
      using yakl::SimpleBounds;
...
void EulerEdgeCentered::create_immersed_proportion_halos(core::Coupler &coupler) const {
      using yakl::SimpleBounds;
      auto nz     = coupler.get_nz();
      auto ny     = coupler.get_ny();
      auto nx     = coupler.get_nx();
