...
void EulerEdgeCentered::ensure_dycore_max_cycles(core::Coupler &coupler, int icycle) const {
...
std::tuple<real,real> EulerEdgeCentered::compute_mass( core::Coupler & coupler , real4d const & state ) const {
      using yakl::SimpleBounds;
      auto nx = coupler.get_nx();
      auto ny = coupler.get_ny();
      auto nz = coupler.get_nz();
...
real EulerEdgeCentered::compute_time_step( core::Coupler const &coupler ) const {
...
void EulerEdgeCentered::time_step(core::Coupler &coupler, real dt_phys) const {
      if (dt_phys <= 0) {
...
void EulerEdgeCentered::time_step_rk3( core::Coupler & coupler ,
                        real4d const  & state   ,
...
void EulerEdgeCentered::time_step_rk4( core::Coupler & coupler ,
                        real4d const  & state   ,
                        real4d const  & tracers ,
                        real            dt_dyn  ,
                        int             icycle  ) const {
...
void EulerEdgeCentered::time_step_ssprk3( core::Coupler & coupler ,
                           real4d const  & state   ,
                           real4d const  & tracers ,
                           real            dt_dyn  ,
                           int             icycle  ) const {
