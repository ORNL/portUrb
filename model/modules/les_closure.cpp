...
std::tuple<real,real> LES_Closure::compute_mass( core::Coupler & coupler , real4d const & state , bool mult_r ) const {
...
void LES_Closure::halo_bcs( core::Coupler const & coupler ,
                   real4d        const & state   ,
