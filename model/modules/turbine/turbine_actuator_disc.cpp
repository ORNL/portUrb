...
void TurbineActuatorDisc::RefTurbine::init( std::string fname ) {
...
real TurbineActuatorDisc::yaw_tend( real uvel , real vvel , real dt , real yaw , real max_yaw_speed ) {
...
void TurbineActuatorDisc::TurbineGroup::add_turbine( core::Coupler       & coupler     ,
                        real                  base_loc_x  ,
                        real                  base_loc_y  ,
...
void TurbineActuatorDisc::init( core::Coupler &coupler ) {
      using yakl::SimpleBounds;
...
void TurbineActuatorDisc::apply( core::Coupler & coupler , float dt ) {
      using yakl::SimpleBounds;
      auto nx    = coupler.get_nx   ();  // Get the local number of x-direction cells
      auto ny    = coupler.get_ny   ();  // Get the local number of y-direction cells
      auto nz    = coupler.get_nz   ();  // Get the number of z-direction cells
...
void TurbineActuatorDisc::disk_average_wind( core::Coupler const & coupler     ,
                            RefTurbine    const & ref_turbine ,
                            real                & avg_u       ,
                            real                & avg_v       ) {
      using yakl::SimpleBounds;
...
float TurbineActuatorDisc::interp( std::vector<real> const &ref_umag , std::vector<real> const &ref_var , real umag ) {
