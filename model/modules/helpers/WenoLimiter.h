...
template <class real> struct WenoLimiter<real,3> {
  static KOKKOS_INLINE_FUNCTION void compute(SArray<real,3> v, real &L, real &R) {
...
template <class real> struct WenoLimiter<real,5> {
  static KOKKOS_INLINE_FUNCTION void compute(SArray<real,5> v, real &L, real &R) {
...
template <class real> struct WenoLimiter<real,7> {
  static KOKKOS_INLINE_FUNCTION void compute(SArray<real,7> v, real &L, real &R) {
...
template <class real> struct WenoLimiter<real,9> {
  static KOKKOS_INLINE_FUNCTION void compute(SArray<real,9> v, real &L, real &R) {
