...
namespace limiter {
  ...
  KOKKOS_INLINE_FUNCTION void static normalize( SArray<real,N> &s , real &mn , real &scale ) {
    mn = s(0);
    real mx = s(0);
    for (int i=1; i < N; i++) {
      mn = std::min( mn , s(i) );
  ...
  template <class real> struct WenoLimiter<real,1> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,1> const &s         ,
                                                              real                 &qL        ,
                                                              real                 &qR        ,
  ...
  template <class real> struct WenoLimiter<real,3> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,3> const &s         ,
                                                              real                 &qL        ,
                                                              real                 &qR        ,
                                                              Params         const &params_in ) {
      SArray<real,2> coefs_L, coefs_R;
    ...
    KOKKOS_INLINE_FUNCTION static real gll_1(real TV_L, real TV_R, bool do_map, SArray<real,3> const &s) {
    ...
    KOKKOS_INLINE_FUNCTION static real gll_2(real TV_L, real TV_R, bool do_map, SArray<real,3> const &s) {
  ...
  template <class real> struct WenoLimiter<real,5> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,5> const &s         ,
                                                              real                 &qL        ,
                                                              real                 &qR        ,
                                                              Params         const &params_in ) {
      SArray<real,3> coefs_L, coefs_C, coefs_R;
    ...
    KOKKOS_INLINE_FUNCTION static real gll_1(real TV_L, real TV_C, real TV_R, bool do_map, SArray<real,5> const &s) {
    ...
    KOKKOS_INLINE_FUNCTION static real gll_2(real TV_L, real TV_C, real TV_R, bool do_map, SArray<real,5> const &s) {
  ...
  template <class real> struct WenoLimiter<real,7> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,7> const &s         ,
                                                              real                 &qL        ,
                                                              real                 &qR        ,
                                                              Params         const &params_in ) {
      SArray<real,4> coefs_1, coefs_2, coefs_3, coefs_4;
    ...
    KOKKOS_INLINE_FUNCTION static real gll_1(real TV_1, real TV_2, real TV_3, real TV_4, bool do_map, SArray<real,7> const &s) {
    ...
    KOKKOS_INLINE_FUNCTION static real gll_2(real TV_1, real TV_2, real TV_3, real TV_4, bool do_map, SArray<real,7> const &s) {
  ...
  template <class real> struct WenoLimiter<real,9> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,9> const &s         ,
                                                              real                 &qL        ,
                                                              real                 &qR        ,
                                                              Params         const &params_in ) {
      SArray<real,5> coefs_1, coefs_2, coefs_3, coefs_4, coefs_5;
    ...
    KOKKOS_INLINE_FUNCTION static real gll_1(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, bool do_map, SArray<real,9> const &s) {
    ...
    KOKKOS_INLINE_FUNCTION static real gll_2(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, bool do_map, SArray<real,9> const &s) {
  ...
  template <class real> struct WenoLimiter<real,11> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,11> const &s         ,
                                                              real                  &qL        ,
                                                              real                  &qR        ,
                                                              Params          const &params_in ) {
      SArray<real,6> coefs_1, coefs_2, coefs_3, coefs_4, coefs_5, coefs_6;
    ...
    KOKKOS_INLINE_FUNCTION static real gll_1(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, bool do_map, SArray<real,11> const &s) {
    ...
    KOKKOS_INLINE_FUNCTION static real gll_2(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, bool do_map, SArray<real,11> const &s) {
  ...
  template <class real> struct WenoLimiter<real,13> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,13> const &s         ,
                                                              real                  &qL        ,
                                                              real                  &qR        ,
                                                              Params          const &params_in ) {
      SArray<real,7> coefs_1, coefs_2, coefs_3, coefs_4, coefs_5, coefs_6, coefs_7;
    ...
    KOKKOS_INLINE_FUNCTION static real gll_1(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, bool do_map, SArray<real,13> const &s) {
    ...
    KOKKOS_INLINE_FUNCTION static real gll_2(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, bool do_map, SArray<real,13> const &s) {
  ...
  template <class real> struct WenoLimiter<real,15> {
    ...
    KOKKOS_INLINE_FUNCTION static void compute_limited_edges( SArray<real,15> const &s         ,
                                                              real                  &qL        ,
                                                              real                  &qR        ,
                                                              Params          const &params_in ) {
      SArray<real,8> coefs_1, coefs_2, coefs_3, coefs_4, coefs_5, coefs_6, coefs_7, coefs_8;
    ...
    KOKKOS_INLINE_FUNCTION static real gll_1(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, real TV_8, bool do_map, SArray<real,15> const &s) {
    ...
    KOKKOS_INLINE_FUNCTION static real gll_2(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, real TV_8, bool do_map, SArray<real,15> const &s) {
