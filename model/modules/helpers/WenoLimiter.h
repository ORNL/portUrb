...
template <class real> struct WenoLimiter<real,3> {
  static KOKKOS_INLINE_FUNCTION void value_based(SArray<real,3> const & v, real &L, real &R, bool immL, bool immR) {
    ...
    TV0 = std::abs(TV0);
    TV1 = std::abs(TV1);
    real r_sm = static_cast<real>(1.)/std::max(static_cast<real>(1.e-20),TV0 + TV1);
    TV0 *= r_sm;
    TV1 *= r_sm;
...
template <class real> struct WenoLimiter<real,5> {
  static KOKKOS_INLINE_FUNCTION void value_based(SArray<real,5> const & v, real &L, real &R, bool immL, bool immR) {
    ...
    TV1 = std::abs(TV1);
    TV2 = std::abs(TV2);
    real r_sm = static_cast<real>(1.)/std::max(static_cast<real>(1.e-20),TV0 + TV1 + TV2);
    TV0 *= r_sm;
    TV1 *= r_sm;
    TV2 *= r_sm;
    if (TV0==0) TV0 = std::min(TV1,TV2);
    if (TV2==0) TV2 = std::min(TV0,TV1);
...
template <class real> struct WenoLimiter<real,7> {
  static KOKKOS_INLINE_FUNCTION void value_based(SArray<real,7> const & v, real &L, real &R, bool immL, bool immR) {
    ...
    TV2 = std::abs(TV2);
    TV3 = std::abs(TV3);
    real r_sm = static_cast<real>(1.)/std::max(static_cast<real>(1.e-20),TV0 + TV1 + TV2 + TV3);
    TV0 *= r_sm;
    TV1 *= r_sm;
    TV2 *= r_sm;
    TV3 *= r_sm;
    if (TV0==0) TV0 = std::min(TV1,std::min(TV2,TV3));
    if (TV3==0) TV3 = std::min(TV0,std::min(TV1,TV2));
...
template <class real> struct WenoLimiter<real,9> {
  static KOKKOS_INLINE_FUNCTION void value_based(SArray<real,9> const & v, real &L, real &R, bool immL, bool immR) {
    ...
    TV3 = std::abs(TV3);
    TV4 = std::abs(TV4);
    real r_sm = static_cast<real>(1.)/std::max(static_cast<real>(1.e-20),TV0 + TV1 + TV2 + TV3 + TV4);
    TV0 *= r_sm;
    TV1 *= r_sm;
    TV2 *= r_sm;
    TV3 *= r_sm;
    TV4 *= r_sm;
    if (TV0==0) TV0 = std::min(TV1,std::min(TV2,std::min(TV3,TV4)));
    if (TV4==0) TV4 = std::min(TV0,std::min(TV1,std::min(TV2,TV3)));
